 ...
 *  Date: 24/04/14
 *  Purpose: to handle details related to the useres input
 * */
...
public class Navigation implements KeyListener, MouseListener, ActionListener{
	...
	public Navigation(AppScreen app, Main m){
		this.app = app;
	...
	public void mouseClicked(MouseEvent e) {
		...
		if(toAdd != ""){
			app.connectionToMain.add(toAdd, mouse);
			toAdd = "";
		}
	}
	...
	public void actionPerformed(ActionEvent a) {
		...
		if(toAdd == "Delete")
			app.connectionToMain.endMolecule();
	}
